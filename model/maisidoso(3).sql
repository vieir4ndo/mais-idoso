...
--
-- Host: 127.0.0.1
-- Tempo de geração: 14-Out-2019 às 20:13
...
CREATE TABLE `atividadefisica` (
  `id_atividadefisica` int(10) UNSIGNED NOT NULL,
  `atividade_atividadefisica` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
...
CREATE TABLE `cartilha` (
  `id_cartilha` int(10) UNSIGNED NOT NULL,
  `titulo_cartilha` text CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `fatores_cartilha` text CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `sintomas_cartilha` text CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `prevencao_cartilha` text CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `cartilha` (`id_cartilha`, `titulo_cartilha`, `fatores_cartilha`, `sintomas_cartilha`, `prevencao_cartilha`) VALUES
...
CREATE TABLE `consulta` (
  ...
  `local_consulta` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `horario_consulta` time NOT NULL,
  `medico_consulta` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `doenca` (
  `id_doenca` int(10) UNSIGNED NOT NULL,
  `nome_doenca` varchar(100) NOT NULL,
  `tipo_doenca` int(11) NOT NULL,
  `sintomas_doenca` text CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `lembrete` (
  `id_lembrete` int(10) UNSIGNED NOT NULL,
  `titulo_lembrete` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
...
CREATE TABLE `medicamento` (
  ...
  `nome_medicamento` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `indicacao_medicamento` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `horario_medicamento` time NOT NULL,
  `dosagem_medicamento` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `restricaoalimentar` (
  `id_restricaoalimentar` int(10) UNSIGNED NOT NULL,
  `alimento_restricaoalimentar` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `grupo_restricaoalimentar` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `razao_restricaoalimentar` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `usuario` (
  ...
  `medicamento_id_medicamento` int(10) UNSIGNED NOT NULL,
  `restricaoalimentar_id_restricaoalimentar` int(10) UNSIGNED NOT NULL,
  `lembrete_id_lembrete` int(10) UNSIGNED NOT NULL,
  `doenca_id_doenca` int(10) UNSIGNED NOT NULL,
  `consulta_id_consulta` int(10) UNSIGNED NOT NULL,
  `atividadefisica_id_atividadefisica` int(10) UNSIGNED NOT NULL,
  `nome_usuario` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `sobrenome_usuario` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
  `genero_usuario` varchar(100) CHARACTER SET latin1 COLLATE latin1_general_ci NOT NULL,
...
ALTER TABLE `restricaoalimentar`
  ADD PRIMARY KEY (`id_restricaoalimentar`);
...
ALTER TABLE `usuario`
  ...
  ADD KEY `usuario_FKIndex1` (`atividadefisica_id_atividadefisica`),
  ADD KEY `usuario_FKIndex2` (`consulta_id_consulta`),
  ADD KEY `usuario_FKIndex3` (`doenca_id_doenca`),
  ADD KEY `usuario_FKIndex4` (`lembrete_id_lembrete`),
  ADD KEY `usuario_FKIndex5` (`restricaoalimentar_id_restricaoalimentar`),
  ADD KEY `usuario_FKIndex6` (`medicamento_id_medicamento`);
...
--
ALTER TABLE `atividadefisica`
  MODIFY `id_atividadefisica` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `cartilha`
--
ALTER TABLE `cartilha`
  MODIFY `id_cartilha` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
...
--
ALTER TABLE `doenca`
  MODIFY `id_doenca` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de tabela `lembrete`
--
ALTER TABLE `lembrete`
  MODIFY `id_lembrete` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `restricaoalimentar`
  MODIFY `id_restricaoalimentar` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `usuario_ibfk_1` FOREIGN KEY (`atividadefisica_id_atividadefisica`) REFERENCES `atividadefisica` (`id_atividadefisica`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `usuario_ibfk_2` FOREIGN KEY (`consulta_id_consulta`) REFERENCES `consulta` (`id_consulta`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `usuario_ibfk_3` FOREIGN KEY (`doenca_id_doenca`) REFERENCES `doenca` (`id_doenca`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `usuario_ibfk_4` FOREIGN KEY (`lembrete_id_lembrete`) REFERENCES `lembrete` (`id_lembrete`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `usuario_ibfk_5` FOREIGN KEY (`restricaoalimentar_id_restricaoalimentar`) REFERENCES `restricaoalimentar` (`id_restricaoalimentar`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `usuario_ibfk_6` FOREIGN KEY (`medicamento_id_medicamento`) REFERENCES `medicamento` (`id_medicamento`) ON DELETE NO ACTION ON UPDATE NO ACTION;
COMMIT;
